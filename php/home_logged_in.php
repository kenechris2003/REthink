...
<html lang="en">
        ...
        <body>
            <header>
            <div class="logo"><a href="">Rethink<span>.</span></a></div>
                <nav>
            ...
            <main>
                ...
                <section class="hero-description">
                    ...
                    <div class="pricing">
                        ...
                        <button class="buy-now"><a href="products.php">Buy Now</a></button>
                    </div>
                    <a href="#accessories" class="browse-accessories">Browse all accessories</a>
                </section>
